...
function AddCategory() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      toast("🎉 Great! You have successfully created a category.", {
    ...
    <div className='ac-container'>
      ...
      <div className='ac-details'>
        ...
        <div style={{ marginTop: '16px', width: '100%' }}>
          ...
          <br />
          <input type="text" value={category} onChange={(e) => setCategory(e.target.value)} style={{ width: '100%', padding: '8px', borderRadius: '4px', border: '1px solid #C2C2C2', fontSize: '16px', marginTop: '5px', backgroundColor: '#FBFBFB', color: 'black' }} placeholder='Enter Category Name' required>
          </input>
        </div>
        ...
        <div style={{ marginTop: '16px', width: '100%' }}>
          ...
          <br />
          <input type="text" value={subcategory} onChange={(e) => setSubcategory(e.target.value)} style={{ width: '100%', padding: '8px', borderRadius: '4px', border: '1px solid #C2C2C2', fontSize: '16px', marginTop: '5px', backgroundColor: '#FBFBFB', color: 'black' }} placeholder='Enter Sub category' required>
          </input>
        </div>
        ...
        <div style={{ marginTop: '16px', width: '100%' }}>
          <span>Brand</span>
          <br />
          <input type="text" value={brand} onChange={(e) => setBrand(e.target.value)} style={{ width: '100%', padding: '8px', borderRadius: '4px', border: '1px solid #C2C2C2', fontSize: '16px', marginTop: '5px', backgroundColor: '#FBFBFB', color: 'black' }} placeholder='Enter Brand' required>
          </input>
        </div>
